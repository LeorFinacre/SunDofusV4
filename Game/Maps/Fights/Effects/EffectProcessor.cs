    ...
    class EffectProcessor
    {
            ...
            else
            {
                ...
                if (cast.Jet > 0)
                {
                    ...
                    if (armor > 0)
                    {
                        ...
                        cast.Caster.Fight.Send(string.Format("GA;105;{0};{1},{2}", cast.Caster.ID, cast.Target.ID, armor));
                    }
                }
                ...
                if (cast.Jet > 0)
                {
                    var reflectDamages = cast.Target.Stats.GetStat(StatEnum.ReflectDamage).Total;
                    ...
                    if (reflectDamages > 0)
                    {
                        ...
                        cast.Caster.Fight.Send(string.Format("GA;107;{0};{1},{2}", cast.Target.ID, cast.Target.ID, reflectDamages));
                        cast.Caster.Fight.Send(string.Format("GA;107;{0};{1},-{2}", cast.Target.ID, cast.Caster.ID, reflectDamages));
                    }
                }
                ...
                cast.Caster.Fight.Send(string.Format("GA;100;{0};{1},-{2}", cast.Caster.ID, cast.Target.ID, cast.Jet));

                if (cast.Target.Life <= 0)
                    cast.Target.Fight.Send(string.Format("GA;103;{0};{1}", cast.Target.ID, cast.Target.ID));
            }
        }
        ...
        public static void EffectDamageDropLife(EffectCast cast)
        {
            ...
            if (cast.Caster == cast.Target)
            {
                ...
                cast.Caster.Fight.Send(string.Format("GA;100;{0};{1},-{2}", cast.Caster.ID, cast.Caster.ID, cast.Jet));

                if (cast.Caster.Life <= 0)
                    cast.Caster.Fight.Send(string.Format("GA;103;{0};{1}", cast.Caster.ID, cast.Caster.ID));
            }
            else
            {
                var givenLife = cast.Jet;
                ...
                cast.Caster.Fight.Send(string.Format("GA;100;{0};{1},{2}", cast.Caster.ID, cast.Target.ID, givenLife));
            }
        }
        ...
        public static void EffectTeleport(EffectCast cast)
        {
            ...
            cast.Caster.Fight.Send(string.Format("GA0;4;{0};{1},{2}", cast.Caster.ID, cast.Caster.ID, cast.CellID));
        }
        ...
        public static void EffectTranspose(EffectCast cast)
        {
            ...
            var casterCell = cast.Caster.Cell;
        ...
        public static void EffectArmor(EffectCast cast)
        {
            ...
            {
                case 1: 
                    cast.Target.Stats.ModifyStatBonus(EffectEnum.AddArmorFeu, cast.Jet); 
                    break;

                case 6: 
                    cast.Target.Stats.ModifyStatBonus(EffectEnum.AddArmorTerre, cast.Jet); 
                    break;

                case 14: 
                    cast.Target.Stats.ModifyStatBonus(EffectEnum.AddArmorAir, cast.Jet);
                    break;

                case 18: 
                    cast.Target.Stats.ModifyStatBonus(EffectEnum.AddArmorEau, cast.Jet); 
                    break;

                default:
                    cast.Target.Stats.ModifyStatBonus(EffectEnum.AddArmor, cast.Jet);
                    break;
            }
        ...
        public static void EffectStats(EffectCast cast)
        {
            ...
            cast.Caster.Fight.Send(string.Format("GA;{0};{1};{2},{3}{4},{5}", (int)cast.Type, cast.Caster.ID, cast.Target.ID, (negative ? "-" : string.Empty), cast.Jet, cast.Duration));
        ...
        public static void EffectSubAPEsquive(EffectCast cast)
        {
            ...
            if (cast.Jet < cast.RandomJet)
                cast.Caster.Fight.Send(string.Format("GA;308;{0};{1},{2}", cast.Caster.ID, cast.Target.ID, (cast.RandomJet - cast.Jet)));
        ...
        public static void EffectSubMPEsquive(EffectCast cast)
        {
            ...
            if (cast.Jet < cast.RandomJet)
                cast.Caster.Fight.Send(string.Format("GA;309;{0};{1},{2}", cast.Caster.ID, cast.Target.ID, (cast.RandomJet - cast.Jet)));
        ...
        public static void EffectStealStats(EffectCast cast)
        {
            ...
            var malusEffect = EffectEnum.None;
            var bonusEffect = EffectEnum.None;
        ...
        public static void EffectPush(EffectCast cast)
        {
            ...
            var lastCell = cast.Target.Cell;
            var length = cast.Type != EffectEnum.PushFear ? cast.RandomJet : Pathfinding.GetDistanceBetween(cast.Caster.Fight.Map, cast.Target.Cell, cast.CellID);

            for (int i = 0; i < length; i++)
            {
                var nextCell = Pathfinding.NextCell(cast.Caster.Fight.Map, lastCell, direction);
                ...
                else
                {
                    ...
                    {
                        cast.Target.Cell = lastCell;
                        cast.Caster.Fight.Send(string.Format("GA0;5;{0};{1},{2}", cast.Caster.ID, cast.Target.ID, lastCell));
                    }
        ...
        {
            var damageCoef = Utilities.Basic.Rand(8, 17);
        ...
        public static void EffectDebuff(EffectCast cast)
        {
            ...
            cast.Caster.Fight.Send(string.Format("GA;132;{0};{1}", cast.Caster.ID, cast.Target.ID));
        }
        ...
        public static void EffectChangeSkin(EffectCast cast)
        {
            ...
            cast.Target.Buffs.AddBuff(cast, BuffActiveType.ACTIVE_STATS, BuffDecrementType.TYPE_ENDTURN);
            cast.Caster.Fight.Send(string.Format("GA;149;{0};{1},{2},{3},{4}", cast.Caster.ID, cast.Target.ID, cast.Value2, cast.Value3, cast.Duration));
        }
        ...
        public static void EffectArnaque(EffectCast cast)
        {
            ...
            cast.Caster.Fight.Send(string.Format("GA;130;{0};{1}", cast.Caster.ID, cast.Jet));
        }
