...
namespace SunDofus.World.Game.Characters
{
    class Character : DatabaseEntity
    {
        ...
        {
            quotaTrade = Environment.TickCount + Utilities.Config.GetInt64("ANTISPAMTRADE");
        }

        public void RefreshRecruitment()
        {
            quotaRecruitment = Environment.TickCount + Utilities.Config.GetInt64("ANTISPAMRECRUITMENT");
        }
