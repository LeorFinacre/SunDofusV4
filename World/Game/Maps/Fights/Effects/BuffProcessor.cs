...
namespace SunDofus.World.Game.Maps.Fights.Effects
{
    class BuffProcessor
    {
        ...
        public static void ApplyBuffMissBack(EffectCast cast, EffectCast actualCast)
        {
            ...
            var chance = cast.Value1;
            var push = cast.Value2;
        ...
        {
            var statsValue = actualCast.Jet / 2;
            var statsType = (EffectEnum)cast.Value1 == EffectEnum.Heal ? EffectEnum.AddVitalite : (EffectEnum)cast.Value1;
            var maxValue = cast.Value2;
            var duration = cast.Value3;
        ...
        {
            var coefDamages = cast.Value1;
            var coefHeal = cast.Value2;
            var chance = cast.Value3;
        ...
        public static void RemoveBuffArmor(EffectCast cast, EffectCast actualCast)
        {
            ...
            {
                case 1:
                    target.Stats.ModifyStatBonus(EffectEnum.SubArmorFeu, cast.Jet);
                    break;

                case 6: 
                    target.Stats.ModifyStatBonus(EffectEnum.SubArmorTerre, cast.Jet); 
                    break;

                case 14: 
                    target.Stats.ModifyStatBonus(EffectEnum.SubArmorAir, cast.Jet); 
                    break;

                case 18: 
                    target.Stats.ModifyStatBonus(EffectEnum.SubArmorEau, cast.Jet); 
                    break;

                default: 
                    target.Stats.ModifyStatBonus(EffectEnum.SubArmor, cast.Jet); 
                    break;
            }
        }
        ...
        public static void RemoveBuffChangeSkin(EffectCast cast, EffectCast actualCast)
        {
            ...
            cast.Caster.Fight.Send(string.Format("GA;149;{0};{1},{2},{3}", cast.Caster.ID, cast.Target.ID, cast.Value3, cast.Value2));
        }
    }
}
